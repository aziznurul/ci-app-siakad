...
class Mahasiswa extends CI_Controller
{
  ...
  {
    $data  = array('id'  => $id);
    $this->m_mahasiswa->hapus_data($data, 'tb_mahasiswa');
    redirect('mahasiswa/index');
  }
  ...
  public function excel()
  {
    ...
    $object->getProperties()->setCreator("Baraya Technology");
    $object->getProperties()->setLastModifiedBy("Baraya Technology");
